  ...
  <div class="header_medium two">
    <div class="container">
      <h3 class="bigtext"> Transfer <span>Bulk Domain</span></h3>
      <!--      <h3 class="smalltext"><span>Select All</span> TLD's</h3>--> 
    </div>
  </div>
    <!--/ .header_medium-->
  ...
  <div class="section_holder4">
    <div class="container">
      <div class="one_full">
        <form action="{$systemsslurl}domainchecker.php?search=bulktransfer" method="post" id="sky-form" class="sky-form">
          <h2 class="uppercase"><strong>Bulk Domain Transfer</strong></h2>
          <fieldset>
            <div class="one_half">
            ...
            <div class="one_half last" style="margin-left:20px;">
              <label class="checkbox one_fifth">
                <input type="checkbox" name="copy" checked disabled>
                <i></i>com</label>
              <label class="checkbox one_fifth">
                <input type="checkbox" name="copy" checked disabled>
                <i></i>net</label>
