    ...
    <div class="tp-banner2" >
      <ul>
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="templates/{$template}/html/images/sliders/slider1_thumb.jpg" data-delay="13000"  data-saveperformance="off"  data-title="Our Workplace"> 
          ...
          <!--Main Image--> 
          <img src="templates/{$template}/html/images/sliders/domain_transfer_bg2.jpg"  > 
          <!--Layers-->
          
          <div class="tp-caption text5 sfl"
						data-x="103"
						data-hoffset="0"
						data-voffset="-10"
						data-y="186"
          ...
          <div class="tp-caption sfb"
			...
			{
				var sList = "";
				var bulkdomains = document.getElementById('dsearch').value;
				jQuery('#dsearch').val(bulkdomains + document.getElementById('tld').value);
				return true;
			}
			</script>
            {/literal}
            <form method="post" id="domain-searchform" action="{$systemsslurl}domainchecker.php?search=bulktransfer" onsubmit="return get_tlds();">
              <div>
                {literal}
                <input class="input-text" name="bulkdomains" id="dsearch" value="Enter your Domain Name here..." onFocus="if (this.value == 'Enter your Domain Name here...') {this.value = '';}" onBlur="if (this.value == '') {this.value = 'Enter your Domain Name here...';}" type="text" />
                {/literal}
                <select class="drlist" id="tld">
                ...
                <input id="searchsubmit" value="Transfer Domain" type="submit" />
              </div>
            </form>
          </div>
