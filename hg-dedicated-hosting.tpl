    ...
    <div class="tp-banner2" >
      <ul>
        <li data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="templates/{$template}/html/images/sliders/slider1_thumb.jpg" data-delay="13000"  data-saveperformance="off"  data-title="Our Workplace"> 
          ...
          <!--Main Image--> 
          <img src="templates/{$template}/html/images/sliders/dedicated_hosting_bg1.jpg"> 
          <!--Layers-->
          ...
          <div class="tp-caption text6 sfb"
						...
						data-endeasing="Power1.easeIn"
						data-captionhidden="off"
						style="z-index: 6">incredibly powerful</div>
          <div class="tp-caption text7 sfb"
						data-x="0"
						data-hoffset="0"
						data-voffset="-10"
						data-y="250"
						...
						data-endeasing="Power1.easeIn"
						data-captionhidden="off"
						style="z-index: 6">Dedicated Servers</div>
  ...
  <div class="section_holder12">
    <div class="container">
      <h1 class="lt_title_big">Linux <span>Features</span></h1>
  ...
  <div class="section_holder2 two">
    <div class="container">
      <h1 class="lt_title_big white">Dedicated <span>Servers</span></h1>
      ...
      <div class="one_fourth">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <div class="price"><sup>$</sup>1.00 <i>/ mo</i></div>
      ...
      <div class="one_fourth">
        ...
        <div class="price_table">
          <div class="plan_info">
            ...
            <div class="price"><sup>$</sup>12.99 <i>/ mo</i></div>
            <ul class="plan_features two">
  ...
  <div class="clearfix"></div>
  <div class="section_holder11 two">
    <div class="container">
      <div class="one_half">
        <h1 class="lt_title_big_left">Our plans <span>Included</span></h1>
        <div class="clearfix"></div>
